...
namespace ProjetV1 {
	...
	/// </summary>
	public ref class MyFormUpdateStaff : public System::Windows::Forms::Form
	{
	public:
		MyFormUpdateStaff(void)
		{
			InitializeComponent();
			//
	...
	private: System::Windows::Forms::ComboBox^ cbx_select_staff;
	...
	private: System::Windows::Forms::TextBox^ txt_box_hire_date;
	...
	private: System::Windows::Forms::Label^ lbl_hire_date;
	...
	private: System::Windows::Forms::Label^ lbl_select_staff;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->cbx_select_staff = (gcnew System::Windows::Forms::ComboBox());
			...
			this->txt_box_hire_date = (gcnew System::Windows::Forms::TextBox());
			...
			this->lbl_hire_date = (gcnew System::Windows::Forms::Label());
			...
			this->lbl_select_staff = (gcnew System::Windows::Forms::Label());
			...
			// cbx_select_staff
			// 
			this->cbx_select_staff->FormattingEnabled = true;
			this->cbx_select_staff->Location = System::Drawing::Point(32, 79);
			this->cbx_select_staff->Name = L"cbx_select_staff";
			this->cbx_select_staff->Size = System::Drawing::Size(185, 24);
			this->cbx_select_staff->TabIndex = 1;
			this->cbx_select_staff->Click += gcnew System::EventHandler(this, &MyFormUpdateStaff::AddCbx);
			...
			this->radioButtonModify->CheckedChanged += gcnew System::EventHandler(this, &MyFormUpdateStaff::radioButtonModify_CheckedChanged);
			// 
			// radioButtonDelete
			// 
			...
			this->radioButtonDelete->CheckedChanged += gcnew System::EventHandler(this, &MyFormUpdateStaff::radioButtonDelete_CheckedChanged);
			// 
			// Modify
			// 
			...
			// txt_box_hire_date
			// 
			this->txt_box_hire_date->Enabled = false;
			this->txt_box_hire_date->Location = System::Drawing::Point(127, 101);
			this->txt_box_hire_date->Name = L"txt_box_hire_date";
			this->txt_box_hire_date->Size = System::Drawing::Size(196, 22);
			this->txt_box_hire_date->TabIndex = 8;
			// 
			// txt_box_address
			// 
			...
			// lbl_hire_date
			// 
			this->lbl_hire_date->AutoSize = true;
			this->lbl_hire_date->Location = System::Drawing::Point(56, 104);
			this->lbl_hire_date->Name = L"lbl_hire_date";
			this->lbl_hire_date->Size = System::Drawing::Size(60, 16);
			this->lbl_hire_date->TabIndex = 15;
			this->lbl_hire_date->Text = L"Hire Date";
			// 
			// lbl_address
			// 
			...
			this->btn_modify->Click += gcnew System::EventHandler(this, &MyFormUpdateStaff::button_modify_Click);
			// 
			// btn_delete
			// 
			...
			this->btn_delete->Click += gcnew System::EventHandler(this, &MyFormUpdateStaff::button_delete_Click);

			// 
			// lbl_select_staff
			// 
			this->lbl_select_staff->AutoSize = true;
			this->lbl_select_staff->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.2F, System::Drawing::FontStyle::Regular,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->lbl_select_staff->Location = System::Drawing::Point(28, 56);
			this->lbl_select_staff->Name = L"lbl_select_staff";
			this->lbl_select_staff->Size = System::Drawing::Size(101, 20);
			this->lbl_select_staff->TabIndex = 27;
			this->lbl_select_staff->Text = L"Select Staff";
			// 
			// groupBox1
			// 
			...
			this->groupBox1->Controls->Add(this->lbl_hire_date);
			...
			this->groupBox1->Controls->Add(this->txt_box_hire_date);
			...
			this->checkBox1->Click += gcnew System::EventHandler(this, &MyFormUpdateStaff::radioButtonLastName_CheckedChanged);
			...
			this->checkBox2->Click += gcnew System::EventHandler(this, &MyFormUpdateStaff::radioButtonFirstName_CheckedChanged);
			// 
			// checkBoxHireDate
			// 
			...
			this->checkBox3->Click += gcnew System::EventHandler(this, &MyFormUpdateStaff::radioButtonHireDate_CheckedChanged);
			// 
			// checkBoxAddress
			// 
			...
			this->checkBox4->Click += gcnew System::EventHandler(this, &MyFormUpdateStaff::radioButtonAddress_CheckedChanged);
			// 
			// MyFormUpdate
			// 
			...
			this->Controls->Add(this->lbl_select_staff);
			...
			this->Controls->Add(this->cbx_select_staff);
			this->Controls->Add(this->dataGridView1);
			this->Name = L"MyFormUpdate";
			this->Text = L"MyFormUpdate";
			this->Load += gcnew System::EventHandler(this, &MyFormUpdateStaff::MyFormUpdate_Load);
...
#pragma endregion
	...
	private: System::Void radioButtonHireDate_CheckedChanged(System::Object^ sender, System::EventArgs^ e) {
		if (this->txt_box_hire_date->Enabled == false) {
			this->txt_box_hire_date->Enabled = true;
		}
		else { this->txt_box_hire_date->Enabled = false; }
	}
	...
	private: System::Void button_modify_Click(System::Object^ sender, System::EventArgs^ e)
	{
		if (this->radioButtonModify->Checked == true) {
			if (this->checkBox1->Checked == true) {
				this->db_sql->actionRows("UPDATE [Projet_V1].[dbo].[staff] SET last_name = '" + this->txt_box_last_name->Text->ToString() + "' WHERE id_staff = (SELECT id_staff FROM staff WHERE first_name = '" 
					+ this->cbx_select_staff->Text->ToString()->Substring(0, this->cbx_select_staff->Text->ToString()->IndexOf(" ")) 
					//+ "' AND last_name =  '"
			...
			if (this->checkBox2->Checked == true) {
				this->db_sql->actionRows("UPDATE [Projet_V1].[dbo].[staff] SET first_name = '" + this->txt_box_first_name->Text->ToString() + "' WHERE id_staff = (SELECT id_staff FROM staff WHERE first_name = '"
					+ this->cbx_select_staff->Text->ToString()->Substring(0, this->cbx_select_staff->Text->ToString()->IndexOf(" "))
					//+ "' AND last_name =  '"
					//+ this->cbx_select_staff->Text->ToString()->Substring(this->cbx_select_staff->Text->ToString()->IndexOf(" "))
					+ "');");
			...
			if (this->checkBox3->Checked == true) {
				this->db_sql->actionRows("UPDATE [Projet_V1].[dbo].[staff] SET hire_date = CONVERT(date, '"+ this->txt_box_hire_date->Text + "') WHERE id_staff = (SELECT id_staff FROM staff WHERE first_name = '"
					+ this->cbx_select_staff->Text->ToString()->Substring(0, this->cbx_select_staff->Text->ToString()->IndexOf(" "))
					//+ "' AND last_name =  '"
					//+ this->cbx_select_staff->Text->ToString()->Substring(this->cbx_select_staff->Text->ToString()->IndexOf(" "))
					+ "');");
				this->txt_box_hire_date->Clear();
			...
			if (this->checkBox4->Checked == true) {
				this->db_sql->actionRows("UPDATE [Projet_V1].[dbo].[address] SET address1 = '" + this->txt_box_address->Text->ToString() + "', city = '" 
					...
					+ this->txt_box_country->Text->ToString() + "' WHERE id_address = (SELECT id_address FROM staff WHERE first_name = '"
					+ this->cbx_select_staff->Text->ToString()->Substring(0, this->cbx_select_staff->Text->ToString()->IndexOf(" "))
					//+ "' AND last_name =  '"
					//+ this->cbx_select_staff->Text->ToString()->Substring(this->cbx_select_staff->Text->ToString()->IndexOf(" "))
					+ "');");
		...
		this->oDs = this->oCad->getRows("SELECT [first_name], [last_name], [hire_date], [id_staff_superieur] FROM [Projet_V1].[dbo].staff", "staff");
		this->dataGridView1->DataSource = this->oDs;
		this->dataGridView1->DataMember = "staff";

		this->cbx_select_staff->ResetText();
	}
	...
	private: System::Void AddCbx(System::Object^ sender, System::EventArgs^ e) {
		this->cbx_select_staff->Items->Clear();
		for (int i = 0; i < (this->dataGridView1->RowCount) - 1; i++) {
			this->cbx_select_staff->Items->Add(this->dataGridView1->Rows[i]->Cells[0]->Value + " " +
	...
	private: System::Void button_delete_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->db_sql->actionRows("DELETE FROM staff WHERE first_name = '" + this->cbx_select_staff->Text->ToString()->Substring(0, this->cbx_select_staff->Text->IndexOf(" "))
			+ "' AND last_name = '"
			+ (this->cbx_select_staff->Text->ToString())->Substring(this->cbx_select_staff->Text->IndexOf(" "))
			+ "';");
		this->dataGridView1->Refresh();
		this->oDs = this->oCad->getRows("SELECT [first_name], [last_name], [hire_date], [id_staff_superieur] FROM [Projet_V1].[dbo].staff", "staff");
		this->dataGridView1->DataSource = this->oDs;
