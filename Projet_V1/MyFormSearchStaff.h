...
namespace ProjetV1 {
	...
	/// Summary for MyForm
	/// </summary>
	public ref class MyFormSearchStaff : public System::Windows::Forms::Form
	{
	public:
		MyFormSearchStaff(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(MyFormSearchStaff::typeid));
			...
			this->comboBox1->Click += gcnew System::EventHandler(this, &MyFormSearchStaff::AddCbxId);
			// 
			// comboBox2
			// 
			...
			this->comboBox2->Click += gcnew System::EventHandler(this, &MyFormSearchStaff::AddCbxFirstName);
			// 
			// comboBox3
			// 
			...
			this->comboBox3->Click += gcnew System::EventHandler(this, &MyFormSearchStaff::AddCbxLastName);
			// 
			// comboBox4
			// 
			...
			this->comboBox4->Click += gcnew System::EventHandler(this, &MyFormSearchStaff::AddCbxBirthdate);
			// 
			// comboBox5
			// 
			...
			this->comboBox5->Click += gcnew System::EventHandler(this, &MyFormSearchStaff::AddCbxFirstCommandDate);
			// 
			// label1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &MyFormSearchStaff::SearchButtonClick);
			// 
			// MyFormSearchStaff
			// 
			...
			this->Name = L"MyFormSearchStaff";
			this->Text = L"Search Staff";
			this->Load += gcnew System::EventHandler(this, &MyFormSearchStaff::MyFormSearch_Load);
...
#pragma endregion
	private: System::Void MyFormSearch_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		this->oDs = this->oCad->getRows("SELECT [id_staff], [first_name], [last_name], [hire_date], [id_staff_superieur] FROM [Projet_V1].[dbo].staff", "staff");
	...
	private: System::Void SearchButtonClick(System::Object^ sender, System::EventArgs^ e) {
		...
		if (comboBox1->Text->ToString() != "") {
			...
			this->dataGridView1->Refresh();
			this->oDs = this->oCad->getRows("SELECT [id_staff], [first_name], [last_name], [hire_date], [id_staff_superieur] FROM [Projet_V1].[dbo].staff WHERE id_staff = '" + this->comboBox1->Text + "'; ", "staff");
			this->dataGridView1->DataSource = this->oDs;
			this->dataGridView1->DataMember = "staff";
		}
			...
			//this->db_sql->actionRows("SELECT [id_client], [first_name], [last_name], [birthdate], [first_command_date] FROM [Projet_V1].[dbo].client WHERE id_client = '" + this->comboBox1->Text + "';");
			this->dataGridView1->Refresh();
			this->oDs = this->oCad->getRows("SELECT [id_staff], [first_name], [last_name], [hire_date], [id_staff_superieur] FROM [Projet_V1].[dbo].staff WHERE first_name = '" + this->comboBox2->Text->ToString() + "'; ", "staff");
			this->dataGridView1->DataSource = this->oDs;
			this->dataGridView1->DataMember = "staff";
		}
			...
			//this->db_sql->actionRows("SELECT [id_client], [first_name], [last_name], [birthdate], [first_command_date] FROM [Projet_V1].[dbo].client WHERE id_client = '" + this->comboBox1->Text + "';");
			this->dataGridView1->Refresh(); 
			this->oDs = this->oCad->getRows("SELECT [id_staff], [first_name], [last_name], [hire_date], [id_staff_superieur] FROM[Projet_V1].[dbo].staff WHERE last_name = '" + this->comboBox3->Text->ToString() + "'; ", "staff");
			this->dataGridView1->DataSource = this->oDs;
			this->dataGridView1->DataMember = "staff";
		}
			...
			//this->db_sql->actionRows("SELECT [id_client], [first_name], [last_name], [birthdate], [first_command_date] FROM [Projet_V1].[dbo].client WHERE id_client = '" + this->comboBox1->Text + "';");
			this->dataGridView1->Refresh();
			this->oDs = this->oCad->getRows("SELECT [id_staff], [first_name], [last_name], [hire_date], [id_staff_superieur] FROM [Projet_V1].[dbo].staff WHERE hire_date = CONVERT(date, '"
				+ this->comboBox4->Text->ToString()->Substring(6, 4) + "/"
				+ this->comboBox4->Text->ToString()->Substring(3, 2) + "/"
				+ this->comboBox4->Text->ToString()->Substring(0, 2) + "'); ", "staff");
			this->dataGridView1->DataSource = this->oDs;
			this->dataGridView1->DataMember = "staff";
		}
			...
			//this->db_sql->actionRows("SELECT [id_client], [first_name], [last_name], [birthdate], [first_command_date] FROM [Projet_V1].[dbo].client WHERE id_client = '" + this->comboBox1->Text + "';");
			this->dataGridView1->Refresh();
			this->oDs = this->oCad->getRows("SELECT [id_staff], [first_name], [last_name], [hire_date], [id_staff_superieur] FROM [Projet_V1].[dbo].staff WHERE first_command_date =  '" + this->comboBox5->Text->ToString() + "';", "staff");
			this->dataGridView1->DataSource = this->oDs;
			this->dataGridView1->DataMember = "staff";
		}
